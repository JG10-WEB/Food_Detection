...
labels = {0: 'Biryani-(600 per plate)', 1: 'Chole bature-(427 per serving)', 2: 'Dhokla-(75 per piece)', 3: 'Dosa-(113 per dosa)', 4: 'Ghevar-(74 per 100 grams)', 5: 'Gulab Jamun-(432 kcal for 100 grams)', 6: 'Halwa-(469 calorie per 100 grams)', 7: 'Idli-(35-39 for medium size)', 8: 'Jalebi-(150 per piece)', 9: 'Kachori-(195 per piece)', 10: 'Kofta-(77 per serving)', 11: 'Ladoo-(204 per piece)', 12: 'Pani puri-(329 per serving)', 13: 'Paratha-(126 per piece)', 14: 'Poha-(158 per cup)', 15: 'Rasgulla-(120 per piece)', 16: 'Samosa-(262 per piece)', 17: 'Vada Pav-(140 per piece)'}
